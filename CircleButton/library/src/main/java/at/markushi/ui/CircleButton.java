...
public class CircleButton extends ImageView {
    ...
    private static final int NORMAL_COLOR_LIGHTUP = 255 / 25;
    ...
    public void setColor(int color) {
        this.defaultColor = getDarkerColor(color,NORMAL_COLOR_LIGHTUP);
    ...
    private int getDarkerColor(int color, int amount) {
