...
public class ImageViewExActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        img6 = (ImageViewEx) findViewById(R.id.imageViewEx6);
        ...
        img6.setSource(Converters.assetToByteArray(getAssets(), "himym-banner.jpg"));

        img6.setFillDirection(ImageViewEx.FillDirection.HORIZONTAL);
    }
}
