 ...
 * </p>
 */
public class SwipeRefreshLayoutRotary extends ViewGroup {
    // Maps to ProgressBar.Large style
    public static final int LARGE = dogaozkaraca.MaterialProgressDrawable.LARGE;
    // Maps to ProgressBar default style
    public static final int DEFAULT = MaterialProgressDrawable.DEFAULT;

    private static final String LOG_TAG = SwipeRefreshLayoutRotary.class.getSimpleName();
    ...
    public View getRotaryLoadingView()
    {
     ...
     * @param context
     */
    public SwipeRefreshLayoutRotary(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public SwipeRefreshLayoutRotary(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void createProgressView() {
        ...
        mCircleView.setImageDrawable(mProgress);
        mCircleView.setVisibility(View.GONE);
        mCircleView.setId(R.id.refresh_rotary);
        addView(mCircleView);
      //  LayoutInflater inflater = (LayoutInflater)getContext().getSystemService (Context.LAYOUT_INFLATER_SERVICE);
      //  RelativeLayout rl = (RelativeLayout) inflater.inflate(R.layout.rl_load, null);
       // RelativeLayout.LayoutParams p = new RelativeLayout.LayoutParams(150,50);

      //  p.addRule(RelativeLayout.BELOW, R.id.refresh_rotary);
