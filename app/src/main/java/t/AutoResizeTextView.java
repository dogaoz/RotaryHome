...
import com.dogaozkaraca.rotaryhome.RotaryView;
...
public class AutoResizeTextView extends TextView {
    ...
    public static final float MIN_TEXT_SIZE = RotaryView.convertDpToPixel(10);

    // Minimum text size for this text view
    public static final float MAX_TEXT_SIZE = RotaryView.convertDpToPixel(16);
    ...
    public AutoResizeTextView(Context context) {
        ...
        if(!isInEditMode())
        {
            Typeface face=Typeface.createFromAsset(context.getAssets(), "fonts/forgotten.ttf");
