...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    private final slidinguppanel.ViewDragHelper mDragHelper;
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDragHelper = slidinguppanel.ViewDragHelper.create(this, 0.5f, new DragHelperCallback());
    ...
    private class DragHelperCallback extends slidinguppanel.ViewDragHelper.Callback {
