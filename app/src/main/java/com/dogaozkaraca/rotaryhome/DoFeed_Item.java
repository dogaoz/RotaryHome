...
public class DoFeed_Item {
 ...
 //   Twitter twitter;
    ...
    public DoFeed_Item(String Type, Date TimePosted, String PostTitle, String ImageURL,String PostURL,String FB_UserId,String postImageURL,String FavLikeHeartCount,String RetweetsReshares,Boolean misLikedFavedHearted) {
