...
public class loadTwitter {
	...
	public static int loadTwitter(String type, String[] TimeLine ,String[] PostTitle ,String[] ImageURL ,String[] PostURL, List<DoFeed_Item> FeedItemList, ConfigurationBuilder twitterConnector)
    {
...
//				}  
	            Log.w("DoFeed_Twitter","Twitter Post Time Parsed :" + TwTimePosted);
					...
					DoFeed_Item df = new DoFeed_Item(type ,TwTimePosted,TwPost,TwPostImageUrl,TwPostUrl,status.getId()+"",mediaUrl,TwFavCount, TwRTCount,status.isFavorited());
